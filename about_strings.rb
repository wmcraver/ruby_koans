...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string  # This one was new for me. I didn't realize that shoveling a value into a variable that references another value would update it too.
    original_string = "Hello, "
    hi = original_string
    there = "World"
    hi << there
  ...
  def test_single_quoted_string_do_not_interpret_escape_characters #This was new for me
    string = '\n'
